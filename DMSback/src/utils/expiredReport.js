...
async function generateExpiredReport(documents, companyName, companyFolder, consentNumber, startDate, endDate, res) {
    ...
    */
    ...
    data.forEach((item) => {
      body.push([
        ...
        { text: item.name, style: "row", alignment: 'center' },
        { text: item.yearStart || "", style: "row", alignment: 'center'},
        { text: item.keepDate !== null ? item.keepDate.toLocaleDateString("en-GB") : 'trajno', style: "row", alignment: 'center'},
        { text: item.serialNumber + ".", style: "row", alignment: 'center' },
        { text: "", style: "row", alignment: 'center'},
