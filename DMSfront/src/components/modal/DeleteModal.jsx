...
const Modal = ({ setModalOn, setChoice, modalMessage, color }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="p-2">
          <h1 className="text-2xl text-gray-800 text-center py-2">{modalMessage}</h1>
          <div className="flex justify-center py-2 gap-4">
            <button
              className={color === 'green' ? "button-basic w-36 m-1 p-4" : "button-delete text-white w-36 m-1 p-4"}
