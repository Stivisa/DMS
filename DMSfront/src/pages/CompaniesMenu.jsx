    ...
    useEffect(() => {
      ...
      <div className="flex justify-center items-center ">
        ...
        <div className="flex items-center justify-center">
          <h1 className="text-2xl p-2 font-bold text-color">IZABERITE FIRMU</h1>
        </div>   
            ...
            >
              <div className={
                    company.name === companyName
                      ? "button-basic text-white hover:bg-teal-300 text-xl font-semibold  flex items-center justify-center text-center"
