...
const Settings = () => {
  ...
  const validateForm = () => {
    ...
    if (invalidChars.test(folderName)) {
      errors.foldernameinvalid =
        'Naziv foldera sadrži nevažeće znakove! Nedozvoljeni znakovi su: <>:"/\\|?*';
    }
    return errors;
  };
  ...
  return (
    <>
      <div className="px-2 py-1 border-2 border-default rounded-lg bg-white">
        <h1 className="text-xl text-default font-bold">
          FIRME KOJE KORISTE ARHIVU
        </h1>
